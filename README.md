...
| [pytorch/gpt](experiments/pytorch/gpt/) | Minimal decoder-only transformer (GPT-style) implemented in PyTorch. Character-level language model trained on the Tiny Shakespeare corpus. |
